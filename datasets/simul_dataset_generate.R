...
#75  80  85  90  95
write.csv(X,file = "datasets/simulated_data/4000sim0.75.csv")
write.csv(simtrue,file = "datasets/simulated_data/4000sim0.75true.csv")
write.csv(label,file = "datasets/simulated_data/4000sim0.75_label.csv")

# write.csv(X,file = "datasets/simulated_data/4000sim0.80.csv")
# write.csv(simtrue,file = "datasets/simulated_data/4000sim0.80true.csv")
# write.csv(label,file = "datasets/simulated_data/4000sim0.80_label.csv")
# 
# write.csv(X,file = "datasets/simulated_data/4000sim0.85.csv")
# write.csv(simtrue,file = "datasets/simulated_data/4000sim0.85true.csv")
# write.csv(label,file = "datasets/simulated_data/4000sim0.85_label.csv")
# 
# write.csv(X,file = "datasets/simulated_data/4000sim0.90.csv")
# write.csv(simtrue,file = "datasets/simulated_data/4000sim0.90true.csv")
# write.csv(label,file = "datasets/simulated_data/4000sim0.90_label.csv")
# 
# write.csv(X,file = "datasets/simulated_data/4000sim0.95.csv")
# write.csv(simtrue,file = "datasets/simulated_data/4000sim0.95true.csv")
# write.csv(label,file = "datasets/simulated_data/4000sim0.95_label.csv")
